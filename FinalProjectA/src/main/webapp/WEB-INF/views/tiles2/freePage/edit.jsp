   ...
   <form name="editFrm">
      <table id="table">
         <tr>
            <th>성명</th>
            <td>
               <input type="hidden" name="seq" value="${boardvo.seq }" readonly="readonly" />
               ${boardvo.name}
            </td>
         </tr>
         <tr>
            <th>제목</th>
            <th><input type="text" name="subject" id="subject" value="${boardvo.subject }"/></th>
         </tr>
         <tr>
            <th>글내용</th>
            <td><textarea name="content" id="content" rows="10" cols="100" style="width: 95%; height: 412px;">${boardvo.content }</textarea> </td>
         </tr>
         <tr>
            <th>글암호</th>
