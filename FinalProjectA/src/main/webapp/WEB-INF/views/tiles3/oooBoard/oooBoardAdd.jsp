	...
	$(document).ready(function(){
		...
		$("#btnWrite").click(function(){
		    ...
		    */    
			...
			frm.method= "POST";   // 파일을 첨부할 경우이라면 반드시 POST이어야만 가능하다. GET이라면  파일첨부가 안되어진다.
			frm.action= "<%=ctxPath%>/oooBoardAddEnd.yo";
			frm.submit();
		});
...
<div style="padding-left: 10%; margin-bottom: -2%; border: solid 0px red;">
	...
	<form name="addFrm" enctype="multipart/form-data">
		...
		<!-- === #125. 답변글쓰기인 경우 부모글의 seq값인 fk_seq값과 부모글의 groupno 값과 부모글의 depthno값을 hidden타입으로보내준다.  ===  -->
