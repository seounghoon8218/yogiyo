...
<script type="text/javascript">
   $(document).ready(function(){
	    ...
	    */    
         ...
         frm.method = "POST";
         frm.action = "<%=ctxPath%>/oooBoardEditEnd.yo";
         frm.submit();
      });
   ...
   <form name="editFrm">
      <table id="table">
         <tr>
            <th>성명</th>
            <td>
               <input type="hidden" name="seq" value="${oooboardvo.seq }" readonly="readonly" />
               ${oooboardvo.name }
            </td>
         </tr>
         <tr>
            <th>제목</th>
            <th><input type="text" name="subject" id="subject" value="${oooboardvo.subject }" /></th>
         </tr>
         <tr>
            <th>글내용</th>
            <td><textarea name="content" id="content" rows="10" cols="100" style="width: 95%; height: 412px;">${oooboardvo.content }</textarea> </td>
         </tr>
         <tr>
            <th>글암호</th>
