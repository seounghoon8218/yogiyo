...
public class BoardVO {
   ...
   private String   status;      // 글삭제여부    1 : 사용가능한 글 / 0 : 삭제된 글
   ...
   //			먼저, 오라클에서 tblComment 테이블과 tblBoard 테이블을 drop 한 뒤에
   ///			tblComment 테이블과 tblBoard 테이블을 재생성 한 이후에
    ...
    */
   private String fileName;       // WAS(톰캣)에 저장될 파일명(20190725092715)
...
public BoardVO(String seq, String fk_email, String name, String subject, String content, String pw, String readCount,
		String regDate, String status, String previousseq, String previoussubject, String nextseq, String nextsubject,
		String commentCount, String groupno, String fk_seq, String depthno, String fileName, String orgFilename,
		String fileSize) {
	super();
	this.seq = seq;
